...
genernalResponder;var _rx=require('rx');var _rx2=_interopRequireDefault(_rx);var _immutable=require('immutable');var _immutable2=_interopRequireDefault(_immutable);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};} /**
...
state=state.withMutations(function(s){return s.
set('initialLayout',_immutable2.default.fromJS(getInitialLayout())).
set('initialTouches',_immutable2.default.fromJS(touches));});}
...
set('touches',_immutable2.default.fromJS(touches)).
